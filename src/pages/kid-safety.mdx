...
Each touchpoint (sticker or QR code) has a "Kid safe" toggle:

![Each touchpoint (sticker or QR code) has a "Kid safe" toggle](/kid-safe-1.png)
...
By tapping a touchpoint or scanning a QR code, you can see the server sets its cookie:
