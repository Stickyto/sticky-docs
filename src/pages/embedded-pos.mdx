...
### `autoUi=posCreatePayment` URL parameter

You can automatically add a payment by setting `autoUi=posCreatePayment`.
...
```
https://dashboard.sticky.to/ops-manager?userPrivateKey=[YOUR_PRIVATE_KEY]&userPublicKey=[YOUR_PUBLIC_KEY]&autoUi=posCreatePayment
```
