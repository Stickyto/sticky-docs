...
### `autoUi=posCreatePaymentAddToTotal` URL parameter

You can automatically add a payment and show the "Add to total" pop up by setting `autoUi=posCreatePaymentAddToTotal`.

Example:

```
https://dashboard.sticky.to/ops-manager?userPrivateKey=[YOUR_PRIVATE_KEY]&userPublicKey=[YOUR_PUBLIC_KEY]&autoUi=posCreatePaymentAddToTotal
```
