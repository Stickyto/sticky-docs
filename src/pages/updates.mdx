...
# 11.9.3 (12 April 2026)
 - Feature: CRM-type grid for partners migrated to partner codes
 - Feature: Work on card payment chargebacks via Chargebacks911 embed
 - Feature: Show gross pricing (called "Gross platform fee") in addition to net pricing per flow

# 11.9.2 (6 April 2026)
 - Feature: CRM-type grid for partners
 ...
 - Feature: Partners can now offer a set of specific payment providers instead of just one
 - Bug: Questions pop up for a product now shows "Pay"-type button language instead of "Add"-type button language when the inherent result is an immediate payment
